...
Future<void> registerDeliveryChargeDependencies() async {
  ...
  deliveryChargeLocator
      .registerFactory(() => RegionBloc(deliveryChargeRepo: deliveryChargeLocator()));

  deliveryChargeLocator.registerLazySingleton<DeliveryChargeRepo>(
          () => DeliveryChargeRepository(deliveryChargeRemoteDataSource: deliveryChargeLocator()));

  deliveryChargeLocator.registerLazySingleton<DeliveryChargeDataSource>(
          () => IDeliveryChargeDataSource(apiService: deliveryChargeLocator()));
}